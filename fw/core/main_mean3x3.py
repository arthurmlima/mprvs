...
for fn in range(1, 10):
    ...
    img ,st0, st1, st2, st3, st4, st5  = mpcall.mpriscv_mean3x3(fn)
    cv2.imwrite('mean3x3/%02i.png' % fn, cv2.cvtColor(img, cv2.COLOR_RGB2BGR))
...
df.to_excel('mean3x3.xlsx', index=False)
